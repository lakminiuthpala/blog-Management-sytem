            ...
            <div class="card">
                ...
                <form action="{{route('blogs.update',$blog->id)}}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                <input class="form-control" name="publish_date" id="title" type="date"
                                       value="{{isset($blog)?$blog->publish_date:old('publish_date')}}">
                        ...
                        <div class="pt-4">
                            <button type="submit" class="btn btn-primary float-right btn-sm">Update Blog</button>
                        </div>
                    </form>
                </div>
            </div>
